    ...
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <div class="user-info" v-if="authStore.isAuthenticated">
                <router-link @click="toggleMenu(false)" to="/userDetail" style="text-decoration: none; color: inherit;">
            ...
            <div class="user-info" v-if="!authStore.isAuthenticated">
                <router-link @click="toggleMenu(false)" to="/login" style="text-decoration: none; color: inherit;">
                    <p style="margin: 0px; padding: 0px; font-size: 13px ; text-decoration: underline ;">
                        [로그인]
                    </p>
                </router-link>
