<template>
    <div>
        ...
        <!-- <button @click="toggleComponent1('Test03');">Test03 로드</button>
        <button @click="toggleComponent1('Test02');">Test02 로드</button> -->
        ...
        <div id="appl2">
            <div class="appl2-img" v-for="food in publicFoods" :key="food.name">
                ...
                <!-- <img src="/images/img_burrito.svg"> -->
                <li>{{ food.name }}</li>
            </div>
        </div>
        <hr>
...
export default {
    data() {
        return {
            ...
            publicFoods: [
                { name: 'Burrito', url: "/vue-project/images/img_burrito.svg" },
                { name: 'Salad', url: "/vue-project/images/img_salad.svg" },
                { name: 'Cake', url: "/vue-project/images/img_cake.svg" },
                { name: 'Soup', url: "/vue-project/images/img_soup.svg" },
                { name: 'Fish', url: "/vue-project/images/img_fish.svg" },
                { name: 'Pizza', url: "/vue-project/images/img_pizza.svg" },
                { name: 'Rice', url: "/vue-project/images/img_rice.svg" }
            ],
        }
    },
    method: {
